...
import com.test.finaltest.databinding.ActivityMaps5Binding;
...
public class MapsActivity5 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng place = new LatLng(35.8614689,128.4964213);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(place);
        markerOptions.title("코로나19 대구광역시 중구 예방접종센터");
        markerOptions.snippet("계명대학교 대구동산병원 별관");
