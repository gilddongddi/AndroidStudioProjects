...
import com.test.finaltest.databinding.ActivityMaps4Binding;
...
public class MapsActivity4 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng place = new LatLng(35.3261303,129.0027039);
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(place);
        markerOptions.title("코로나19 영남권역 예방접종센터");
        markerOptions.snippet("양산 부산대병원 기숙사동 1층");
